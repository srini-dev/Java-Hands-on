 ...
 * @author user
 */
public class FinalTRN extends javax.swing.JInternalFrame {

    /** Creates new form RepFrm */
    public FinalTRN() {
        super("ಖಾತೆದಾರನ ವಿವರ",false,true,false,true);
    ...
    public FinalTRN(String fileName,HashMap param) throws SQLException, ClassNotFoundException
    {
        this();
