 ...
 * @author user
 */
public class CstBdate extends javax.swing.JInternalFrame {

    /** Creates new form RepFrm */
    public CstBdate() {
        super("ನೋಂದಣ ಆರಂಭ ಮತ್ತು ಮುಕ್ತಾಯ ದಿನಾಂಕ ಖಾತೆದಾರನ ವಿವರ",false,true,false,true);
    ...
    public CstBdate(String fileName,HashMap param) throws SQLException, ClassNotFoundException
    {
        this();
