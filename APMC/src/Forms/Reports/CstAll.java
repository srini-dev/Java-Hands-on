 ...
 * @author user
 */
public class CstAll extends javax.swing.JInternalFrame {

    /** Creates new form RepFrm */
    public CstAll() {
        super("ಎಲ್ಲಾ ಖಾತೆದಾರರ ವಿವರಗಳು",false,true,false,true);
    ...
    public CstAll(String fileName) throws SQLException, ClassNotFoundException
    {
        this();
        conn=new DBConnect().GetConnetion();
        try{
            File fl=new File("src\\Forms\\Reports\\CstALL.jrxml");
