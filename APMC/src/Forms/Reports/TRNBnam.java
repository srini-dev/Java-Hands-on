 ...
 * @author user
 */
public class TRNBnam extends javax.swing.JInternalFrame {

    /** Creates new form RepFrm */
    public TRNBnam() {
        super("ಹೆಸರಿನ ಮೆಲೆ ಖಾತೆದಾರರ ವಿವರಗಳು ",false,true,false,true);
    ...
    public TRNBnam(String fileName,HashMap param) throws SQLException, ClassNotFoundException
    {
        this();
        conn=new DBConnect().GetConnetion();
        try{
            File fl=new File("src\\Forms\\Reports\\TrnBName.jrxml");
