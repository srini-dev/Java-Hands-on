...
public class Silvertrs_mod {
    ...
    public Silvertrs_mod(String cid, String tid,String slno,Date t_date, String purch_item, Double goldrate, Double weight, Double mak_chrg, Double tax, Double totamt,Date rtnDat) {
        this.cid = cid;
        this.tid = tid;
        this.slno = slno;
        this.t_date = t_date;
