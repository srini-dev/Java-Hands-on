...
import Admin.DataBase.DBConnect.*;
public class GoldMessagingserv
{
    ...
    ResultSet rs=null;
    public boolean goldmessing(String cust_id, String cust_name, String addre, String city, String phn_no, Double pay_amt, Double paid, Double bal,String date) {
        try
        {
