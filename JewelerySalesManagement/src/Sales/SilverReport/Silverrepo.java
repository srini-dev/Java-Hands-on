 ...
 * @author user
 */
public class Silverrepo extends javax.swing.JInternalFrame {
    ...
    Connection conn=null;
     public Silverrepo(String fileName,HashMap param) throws SQLException, ClassNotFoundException
    {
        this();
        conn=new DBConnect().GetConnetion();
        try{
            System.out.println("----"+param);
            File fl=new File("src/Sales/SilverReport/Silverrepo.jrxml");
