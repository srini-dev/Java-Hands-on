...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        this.setTitle(MetalRate.titl);
        jLabel1.setText(MetalRate.titl);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SS  JEWELLERY SHOP");
    ...
    public void logIn()
    {
        ...
        if(b)
        {
                ...
                if(flag)
                {
                  try{new MainMenu();}catch(IOException ie){}this.setVisible(false);
              }
                else
