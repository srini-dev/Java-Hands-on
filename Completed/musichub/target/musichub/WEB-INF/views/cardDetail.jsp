...
<div class="container" style="width: 50%; margin: 35px auto;">
	<form:form
		action="${pageContext.request.contextPath}/cardDetail/${order.cart.cartId}"
		method="post" commandName="carddetail">
		...
		<div>
			...
			<div>
				...
				<div>
					<input style="margin-right: 10px;" type="submit" value="Pay Now"
