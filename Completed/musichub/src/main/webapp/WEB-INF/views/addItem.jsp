...
<div class="container" style="width: 40%; margin: 35px auto;">
	<form:form
		action="${pageContext.request.contextPath}/admin/item/addItem"
		...
		<div>
			...
			<div class="control-group">
				...
				<div class="controls docs-input-sizes">
					<form:input path="itemInStock" id="ItemInStock"
						class="form-Control" />
				</div>
			</div>
			<div class="control-group">
		...
		<div>
			...
			<br>
			<div>
				<input style="margin-right: 5px !important;" " type="submit"
					value="Submit" class="btn btn-primary pull-left" />
			</div>
			<div">
